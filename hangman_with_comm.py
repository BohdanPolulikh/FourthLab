...
def antycheat(user_input: str, last_user_input: str, initial_len_of_input: int, last_letter='') -> typing.Tuple[str, int]:
    """
        ...
        :param last_letter : остання спроба
    """
    corrected_input: str = user_input

    while last_letter not in corrected_input:
        print("Де буква?")
        print(f'Останнім варіантом було {last_user_input}. Якщо я вгадав - запиши сюди букву {last_letter}!')
...
#Инициализируем все перед началом игры
    ...
    while is_playing:
        ...
        if was_correct:
            ...
            current_word, len_of_word = antycheat(current_word, last_word, len_of_word, last_try)
